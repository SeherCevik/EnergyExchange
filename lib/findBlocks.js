function findBlocks(contractDepthHistory) {
    ...
    let min= Date.parse(contractDepthHistory[0].tradeClose) - Date.parse(contractDepthHistory[0].dateTime);
    let remainingMinutes = Math.floor((min/1000/60) << 0);
    ...
    const expectedResult1 =
    {
        ...
        remainingMinutes : Math.floor((min/1000/60) << 0),
